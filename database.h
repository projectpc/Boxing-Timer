...
#define DATABASE_NAME       "TimerBase.db"//"Name.db"
...
public slots:
    ...
    QList<QString> getTitle(QString name);
    QString getValue(QString TableName, QString ColumnName, QString id);
    QString getColor(QString name);

    void setColor(QString name, QString colors);

    int getCountCol(QString name);
    int getCountRow(QString name);
